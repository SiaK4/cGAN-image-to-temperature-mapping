"""
The combine_A_and_B.py script is taken from Pytorch implementation of Pix2Pix model:
https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix/tree/master/datasets
